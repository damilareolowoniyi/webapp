        ...
        <section id="main" class="p-relative" role="main">
            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled side-menu">
                    <li>
                        <a class="fa fa-user" href="trainerprofile.php?user=<?php echo escape($user->data()->username); ?>">
                            <span class="menu-item">Profile</span>
                        </a> 
                    </li>
                    <li>
                        <a class="fa fa-users" href="trainerprofile.php?user=<?php echo escape($user->data()->username); ?>">
                    ...
                    <li  class="active">
                        <a class="fa fa-calendar" href="trainer_schedule.php?user=<?php echo escape($user->data()->username); ?>">
