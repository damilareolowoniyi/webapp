                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        <ul class="nav navbar-nav navbar">
                                            <li class="hidden">
                                             ...
                                             <li>
                                                <a class="btn btn-primary" data-toggle="modal" data-target="#myModal" href="#">Add Workout</a>
                                            </li>
                                            <li>
                                                <a class="page-scroll" href="#">View This Weeks Workouts</a>
                                            </li>
                                            <li>
                                                <a class="page-scroll" href="#">View Future Workouts</a>
                                            </li>  
                                             <li>
                                                <a class="page-scroll" href="#">View Past Workouts</a>
                                            </li>              
                                        </ul>
                                    </div>                                    
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Workout Plan</h4>
      </div>
      <div class="modal-body">
        
<form>
<div class="form-group">
    <label for="wp">Workout Name</label>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="wg">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="wn">
  </div>
</form>
        
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel this workout plan</button>
        <button type="button" id="save" class="btn btn-primary">Save this workout plan</button>
      </div>
    </div>
  </div>
</div>    
<div id="info"></div>
    ...
    var datas="&wp="+wp+"&en="+en+"&st="+st+"&wg="+wg+"&rp="+rp+"&wn="+wn;
