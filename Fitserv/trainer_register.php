        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a class="page-scroll" href="trainer_register.php">Sign Up</a>
                    </li>
					 <li>
                        <a class="page-scroll" href="trainer_login.php">Sign In</a>
                    </li>
                    <li>
                         <?php
    ...
    <header>
        ...
        <div class="container">
              ...
              <form class="form-login" action="" method="post">
                <h2 class="form-login-heading">Trainer Register</h2>
                <div class="login-social-link centered">                    
                        
                       
                       <a href="user_register.php">Not a Trainer? Register as Standard User here!</a>
                </div>
